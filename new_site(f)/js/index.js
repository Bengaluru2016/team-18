...
$(function() {
	...
	$("#rad-chat-send").on("click", function() {
		...
		var img = "http://3.bp.blogspot.com/-coH7JStVgw8/TmvdyNQBWhI/AAAAAAAAGQw/V63AT0PZF9o/s1600/Funny+cartoon+faces+pictures2.jpg";
		if (value=="hi"||value=="hey"||value=="hello"||value=="Hi"||value=="hola") {
			$("#rad-chat-txt").val('');
			$ele.append(getTempl(img, value, 'left'));
			setTimeout(function() {
				img = "https://pbs.twimg.com/profile_images/535502528490655744/6N28C6iP.jpeg";
				$ele.append(getTempl(img, "Hello Sir, How can we help you?", 'right'));
				$ele.slimScroll({
	...
	$("#rad-chat-send").on("click", function() {
		...
		var $ele = $(".rad-chat-body");
		var img = "http://3.bp.blogspot.com/-coH7JStVgw8/TmvdyNQBWhI/AAAAAAAAGQw/V63AT0PZF9o/s1600/Funny+cartoon+faces+pictures2.jpg";
		if (value=="who are you?"||value=="who r u"||value=="who are u"||value=="who r you"||value=="who r u?"||value=="who are u?"||value=="who are you?"||value=="who are yu?") {
			$("#rad-chat-txt").val('');
			$ele.append(getTempl(img, value, 'left'));
			setTimeout(function() {
				img = "https://pbs.twimg.com/profile_images/535502528490655744/6N28C6iP.jpeg";
				$ele.append(getTempl(img, "I am a bot. I am here to brief up the things about the website and the NGO", 'right'));
				$ele.slimScroll({
					scrollTo: $ele[0].scrollHeight
				});
			}, 2000);
	...
	$("#rad-chat-send").on("click", function() {
		...
		var $ele = $(".rad-chat-body");
		var img = "http://3.bp.blogspot.com/-coH7JStVgw8/TmvdyNQBWhI/AAAAAAAAGQw/V63AT0PZF9o/s1600/Funny+cartoon+faces+pictures2.jpg";
		if (value=="how am i benifited in this process?") {
			$("#rad-chat-txt").val('');
			$ele.append(getTempl(img, value, 'left'));
			setTimeout(function() {
				img = "https://pbs.twimg.com/profile_images/535502528490655744/6N28C6iP.jpeg";
				$ele.append(getTempl(img, "The money invested by the investors would definitely help a family which is benifitable than anything", 'right'));
				$ele.slimScroll({
					scrollTo: $ele[0].scrollHeight
				});
			}, 2000);
	...
	$("#rad-chat-send").on("click", function() {
		...
		if (value=="oh cool") {
			...
			setTimeout(function() {
				img = "https://pbs.twimg.com/profile_images/535502528490655744/6N28C6iP.jpeg";
				$ele.append(getTempl(img, "Ya it is, :-)", 'right'));
				$ele.slimScroll({
					scrollTo: $ele[0].scrollHeight
				});
			}, 2000);
	...
	$("#rad-chat-send").on("click", function() {
		...
		var $ele = $(".rad-chat-body");
		var img = "http://3.bp.blogspot.com/-coH7JStVgw8/TmvdyNQBWhI/AAAAAAAAGQw/V63AT0PZF9o/s1600/Funny+cartoon+faces+pictures2.jpg";
		if (value=="bye"||value=="Bye") {
			$("#rad-chat-txt").val('');
			$ele.append(getTempl(img, value, 'left'));
			setTimeout(function() {
				img = "https://pbs.twimg.com/profile_images/535502528490655744/6N28C6iP.jpeg";
				$ele.append(getTempl(img, "Bye, :-)... I hope I have solved your queries.", 'right'));
				$ele.slimScroll({
					scrollTo: $ele[0].scrollHeight
				});
			}, 2000);
	...
	$("#rad-chat-send").on("click", function() {
		...
		if (value) {
			...
			setTimeout(function() {
				img = "https://pbs.twimg.com/profile_images/535502528490655744/6N28C6iP.jpeg";
				$ele.append(getTempl(img, "Sorry but the query which you have entered is not in my directory. For further more details please contact the contact number provided: 95946451", 'right'));
				$ele.slimScroll({
					scrollTo: $ele[0].scrollHeight
				});
			}, 2000);
	...
	function initializeCharts() {
		...
		Morris.Line({
			...
			labels: ['Target', 'Current', 'Your Contribution'],
			pointSize: 0,
			hideHover: 'auto'
		});
